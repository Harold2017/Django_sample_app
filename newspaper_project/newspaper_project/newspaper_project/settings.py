...
SECRET_KEY = 'j#dgj2rj_b3bhck6ht9)7tkl6_5#dk07=t#iudf!o#1%^!f_ag'
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'templates')],  # get_template_dir()
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
# Email backend for outputting the email text to command line console
